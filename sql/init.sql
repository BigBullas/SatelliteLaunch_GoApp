...
create table if not exists requests_for_delivery
(
...
create table if not exists flights_requests
(
    flight_id       integer 
...
INSERT INTO requests_for_delivery(request_id, is_available, img_url, title, load_capacity,
